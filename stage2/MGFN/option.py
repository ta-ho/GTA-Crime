...
def parse_args():
    ...
    parser.add_argument('--feature_size', type=int, default=1024, help='size of feature (default: UCF:2048//xd:1024)')
    ...
    parser.add_argument('--rgb-list', default='list/RTFM/UCF3_Train.list', help='list of rgb features ')
    parser.add_argument('--test-rgb-list', default='list/RTFM/UCF3_Test.list', help='list of test rgb features ')
    parser.add_argument('--gt', default='list/RTFM/gt_ucf_SFN_I3D.npy', help='file of ground truth ')
    ...
    parser.add_argument('--gpus', type=str, default='2', help='gpus')
    parser.add_argument('--lr', type=str, default='[0.001]*500', help='learning rates for steps(list form) default:0.001')
    ...
    parser.add_argument('--weight-path', default='weights/ucf_wgan_each.pth', help='path to load weights')
    parser.add_argument('--seed', type = int, default = 2024, help = 'random seed (-1 for no manual seed)')
