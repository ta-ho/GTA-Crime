...
parser.add_argument('--rgb-list', default='list/UCF3_Train.list', help='list of rgb features ')
parser.add_argument('--test-rgb-list', default='list/UCF3_Test.list', help='list of test rgb features ')
parser.add_argument('--gt', default='list/gt_ucf_SFN_I3D.npy', help='file of ground truth ')
parser.add_argument('--gpus', default=1, type=int, choices=[0], help='gpus')
parser.add_argument('--lr', type=str, default='[0.001]*1000', help='learning rates for steps(list form)')
...
parser.add_argument('--seed', type = int, default = 223, help = 'random seed (-1 for no manual seed)')
